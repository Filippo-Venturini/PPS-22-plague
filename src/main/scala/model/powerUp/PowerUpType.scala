...
enum PowerUpType(val price: Int, val prerequisite: List[PowerUpType], val logic: PowerUpLogic):
  ...
  case BacterialResistance extends PowerUpType(2, List(), bacterialResistance)
  ...
  case InfectionThroughAnimals extends PowerUpType(2, List(ColdResistanceII, HotResistanceI), infectionThroughAnimals)
