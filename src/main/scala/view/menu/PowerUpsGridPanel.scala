...
class PowerUpsGridPanel(powerUpDetailsPanel: PowerUpDetailsPanel, menuController: MenuController) extends JPanel:
  ...
  btnColdResistanceI.button.addActionListener((e: ActionEvent) => powerUpDetailsPanel.refreshPowerUpInformation(powerUpColdResistanceI, this.menuController.powerUpsAvailableForPurchase(powerUpColdResistanceI)))
  ...
  btnInfectedDrinkingWater.button.addActionListener((e: ActionEvent) => powerUpDetailsPanel.refreshPowerUpInformation(powerUpInfectedDrinkingWater, this.menuController.powerUpsAvailableForPurchase(powerUpInfectedDrinkingWater)))
  ...
  btnAlphaMutations.button.addActionListener((e: ActionEvent) => powerUpDetailsPanel.refreshPowerUpInformation(powerAlphaMutations, this.menuController.powerUpsAvailableForPurchase(powerAlphaMutations)))
  ...
  btnColdResistanceII.button.addActionListener((e: ActionEvent) => powerUpDetailsPanel.refreshPowerUpInformation(powerUpColdResistanceII, this.menuController.powerUpsAvailableForPurchase(powerUpColdResistanceII)))
  ...
  btnInfectionThroughAnimals.button.addActionListener((e: ActionEvent) => powerUpDetailsPanel.refreshPowerUpInformation(powerUpInfectionThroughAnimals, this.menuController.powerUpsAvailableForPurchase(powerUpInfectionThroughAnimals)))
  ...
  btnHotResistanceII.button.addActionListener((e: ActionEvent) => powerUpDetailsPanel.refreshPowerUpInformation(powerUpHotResistanceII, this.menuController.powerUpsAvailableForPurchase(powerUpHotResistanceII)))
  ...
  btnBetaMutations.button.addActionListener((e: ActionEvent) => powerUpDetailsPanel.refreshPowerUpInformation(powerUpBetaMutations, this.menuController.powerUpsAvailableForPurchase(powerUpBetaMutations)))
  ...
  btnAirportEnablement.button.addActionListener((e: ActionEvent) => powerUpDetailsPanel.refreshPowerUpInformation(powerUpAirportEnablement, this.menuController.powerUpsAvailableForPurchase(powerUpAirportEnablement)))
  ...
  btnBacterialResistance.button.addActionListener((e: ActionEvent) => powerUpDetailsPanel.refreshPowerUpInformation(powerUpBacterialResistance, this.menuController.powerUpsAvailableForPurchase(powerUpBacterialResistance)))
  ...
  btnOmegaMutations.button.addActionListener((e: ActionEvent) => powerUpDetailsPanel.refreshPowerUpInformation(powerUpOmegaMutations, this.menuController.powerUpsAvailableForPurchase(powerUpOmegaMutations)))
  ...
  btnGammaMutations.button.addActionListener((e: ActionEvent) => powerUpDetailsPanel.refreshPowerUpInformation(powerUpGammaMutations, this.menuController.powerUpsAvailableForPurchase(powerUpGammaMutations)))
  ...
  btnMedicinesResistance.button.addActionListener((e: ActionEvent) => powerUpDetailsPanel.refreshPowerUpInformation(powerUpMedicinesResistance, this.menuController.powerUpsAvailableForPurchase(powerUpMedicinesResistance)))
  ...
  btnInfectionThroughRespiratoryTract.button.addActionListener((e: ActionEvent) => powerUpDetailsPanel.refreshPowerUpInformation(powerUpInfectionThroughRespiratoryTract, this.menuController.powerUpsAvailableForPurchase(powerUpInfectionThroughRespiratoryTract)))
  ...
  btnPortEnablement.button.addActionListener((e: ActionEvent) => powerUpDetailsPanel.refreshPowerUpInformation(powerUpPortEnablement, this.menuController.powerUpsAvailableForPurchase(powerUpPortEnablement)))
  ...
  def refreshPowerUpGridPanel(): Unit =
    buttons.filter(btnPowerUp => menuController.powerUpsAvailableForPurchase(btnPowerUp.powerUp)).foreach(btnPowerUp => {
